...
const SinglePartyOptions: React.FC = () => {
    ...
    const handleSelectChange = (event:React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (option !== null && option !== 'defaultValue') {
    ...
    return (
        <div className="flex py-3 items-center">
            ...
            <select id="countries" disabled={!isSinglePartyEnabled} value={selectedParty || 'defaultValue'}
                    onChange={handleSelectChange}
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option selected value="defaultValue" disabled={selectedParty != null}>Wybierz partię</option>
